...
export default function Signup() {
  ...
  async function createSession(idToken: string) {
    ...
    /* ?welcome=1 triggers the Pro-trial congratulations modal on first dashboard render */
  ...
  async function handleEmailSignup(e: React.FormEvent) {
    ...
    try {
      ...
      /* Set display name so session route picks it up */
      ...
      <div className="bg-card border border-border rounded-2xl shadow-sm p-8 space-y-6">
        ...
        <div className="text-center space-y-1">
          ...
          <p className="text-sm text-muted-foreground">
            Start writing SEO blogs for free
          </p>
        </div>
        ...
        <p className="text-center text-xs text-muted-foreground">
          Free plan includes 2 high-quality blogs to get you started.
        </p>
      </div>
